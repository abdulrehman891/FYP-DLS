...
<div class="page-wrapper">
  <div class="page-content">
    ...
    <div class="card">
      ...
      $sql = "SELECT * FROM cases WHERE client_name = '".$_REQUEST['client_name']."' AND lawyer_id = '".$_REQUEST['lawyer_id']."'";
      $result = mysqli_query($conn, $sql);
      if(mysqli_num_rows($result) <1){
        echo "<h4 class='alert alert-info text-center'>Sorry! Lawyer has not register your case details yet!</h4>";
      }else {
      ...
      <a href="myLawyer.php" class="btn btn-dark">Back</a>
