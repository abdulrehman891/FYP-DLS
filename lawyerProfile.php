                            ...
                            <div class="col-lg-12 mt-0">
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <span>
                                            <i class="fa-solid fa-star" onClick="rateOne();" id="rateOne"></i>
                                            <i class="fa-solid fa-star" onClick="rateTwo();" id="rateTwo"></i>
                                            <i class="fa-solid fa-star" onClick="rateThree();" id="rateThree"></i>
                                            <i class="fa-solid fa-star" onClick="rateFour();" id="rateFour"></i>
                                            <i class="fa-solid fa-star" onClick="rateFive();" id="rateFive"></i>
                                        </span>  

                                        <form action="" method="get">
                                            <input type="hidden" name="rateValue" id="rateValue">                                            
                                            <button type="button" class="btn btn-success" id="rateNow" name="rateNow" disabled>Rate Now</button>
                                        </form>
                                ...
                                <form action="" method="post" class="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            ...
                                            <input type="hidden" name="lawyerId" id="lawyerId" value="<?php echo $row['lawyer_id'] ?>">
...
function rateOne(){
    $('#rateOne').addClass('text-warning');
    $('#rateTwo').removeClass('text-warning');
    $('#rateThree').removeClass('text-warning');
    $('#rateFour').removeClass('text-warning');
    $('#rateFive').removeClass('text-warning');
    $('#rateValue').val(1);
    $('#rateNow').attr('disabled', false);
}
function rateTwo(){
    $('#rateOne').addClass('text-warning');
    $('#rateTwo').addClass('text-warning');
    $('#rateThree').removeClass('text-warning');
    $('#rateFour').removeClass('text-warning');
    $('#rateFive').removeClass('text-warning');
    $('#rateValue').val(2);
...
function rateThree(){
    $('#rateOne').addClass('text-warning');
    $('#rateTwo').addClass('text-warning');
    $('#rateThree').addClass('text-warning');
    $('#rateFour').removeClass('text-warning');
    $('#rateFive').removeClass('text-warning');
    $('#rateValue').val(3);
    $('#rateNow').attr('disabled', false);
...
function rateFour(){
    ...
    $('#rateTwo').addClass('text-warning');
    $('#rateThree').addClass('text-warning');
    $('#rateFour').addClass('text-warning');
    $('#rateFive').removeClass('text-warning');
    $('#rateValue').val(4);
    $('#rateNow').attr('disabled', false);
}
function rateFive(){
    ...
    $('#rateThree').addClass('text-warning');
    $('#rateFour').addClass('text-warning');
    $('#rateFive').addClass('text-warning');
    $('#rateValue').val(5);
    $('#rateNow').attr('disabled', false);
}
    ...
    $('#rateNow').click(function (e) { 
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response == 1)  {
                    $('#msg').html('<div class="alert alert-success alert-dismissible fade show" role="alert">                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>                                  <strong>Thanks</strong> For Rating!</div>');
                }              
            }
        });
