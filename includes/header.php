        ...
        <a class="navbar-brand ms-5 " href="index.php"><img width="120px" src="assets/logo/logo2.png" alt="" srcset=""></a> 
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto me-5">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(PAGE == 'Practice Areas') echo 'active'; ?>"
                            href="practices.php">Practice Areas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if(PAGE == 'Services') echo 'active'; ?>"
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(PAGE == 'Contact Us') echo 'active'; ?>" href="contact.php">Contact
                            Us</a>
                    </li>
                    <?php
