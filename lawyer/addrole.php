        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    ...
                    <!-- <div class="ms-auto">
                        <div class="btn">
                            <a href="./viewproduct.php" type="button" class="btn btn-primary">View</a>
                        ...
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body p-5">
                                <div class="card-title d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-primary">Role Addition</h5>
                                </div>
                                <hr>
                                <form id="data">
                                    <div class="row g-3">
                                        ...
                                        <div style="margin: 0px auto;" class="col-md-8 mt-2">
                                            ...
                                            <select class="inp form-control" onchange="show();" name="access"
                                                id="access">
                                        ...
                                        <div style="margin: 0px auto;display:none;" class="col-md-8 mt-2"
                                            id="custom_field">

                                            <input type="checkbox" name="lawyer" value="lawyer">Lawyer
                                            <br><input type="checkbox" name="clients" value="clients">Clients
                                            <br><input type="checkbox" name="case" value="case">Case
                                            <br><input type="checkbox" name="appoinment" value="appoinment">Appoinment
                                            <br><input type="checkbox" name="team_member" value="team_member">Team Member
                                            <br><input type="checkbox" name="tasks" value="tasks">Tasks
                                            <br><input type="checkbox" name="setting" value="setting">Setting
                                            <br><input type="checkbox" name="user" value="user manegment">User
