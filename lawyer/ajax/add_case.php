...
if ($cnic == "" || $clientname == "" || $clientmobile == "" || $petitioner == "" || $petitioner_advocate == "" || $respondent == "" || $respondent_advocate == "" || $province == "" || $district == "" || $tehsil == "" || $court == "" || $court_type == "" || $court_name == "" || $judge == "" ||  $case == "" || $casecategory == "" || $casesubcategory == "" || $case_no == "" || $case_date == "" || $cnr == "" || $registration_date == "" || $police_station == "" || $fir_number == "" || $fir_date == "" || $file_no == "" || $file_date == "" || $act == "" || $under_section == "" || $last_date == "" || $Next_date == "" || $purpose == "") {
  ...
  $sql = "INSERT INTO `add_case`( `la_id`,`cnic`, `client_name`, `client_mobile`, `petitioner_name`, `p_advocate_name`, `respondent_name`, `r_advocate_name`, `province`, `district`, `tehsil`, `court`, `court_type`, `court_name`, `judge`, `case_tye`, `case_category`, `case_sub_category`, `case_number`, `case_date`, `cnr`, `registration_date`, `police_station`, `fir_number`, `fir_date`, `file_number`, `file_date`, `act`, `under_section`, `last_date`, `next_date`, `purpose_of_hearing`) VALUES ('$lawyer_key','$cnic','$clientname','$clientmobile','$petitioner','$petitioner_advocate','$respondent','$respondent_advocate','$province','$district','$tehsil','$court','$court_type','$court_name','$judge','$case','$casecategory','$casesubcategory','$case_no','$case_date','$cnr','$registration_date','$police_station','$fir_number','$fir_date','$file_no','$file_date','$act','$under_section','$last_date','$Next_date','$purpose')";
