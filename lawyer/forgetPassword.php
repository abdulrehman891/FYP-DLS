...
if(isset($_REQUEST['submit'])){
	...
	elseif(mysqli_num_rows(mysqli_query($conn, "SELECT * FROM lawyer WHERE lawyer_email = '$email'")) < 1){
		...
		$sql = "UPDATE lawyer SET token = '$token' WHERE lawyer_email = '$email'";
		...
		$body = "Hi, Please click here to Reset your password http://localhost/fyp-dls/lawyer/resetPassword.php?token=$token";
				...
				<div class="card-body">
					<div class="p-4 rounded  border">
						<div class="text-center">
							<img src="assets/images/icons/forget.png" width="120" alt="">
						</div>
						...
						<form action="" method="get">
							...
							<div class="d-grid gap-2">
								<button type="submit" name="submit" class="btn btn-dark btn-lg">Send</button> <a href="lawyerLogin.php" class="btn btn-light btn-lg"><i class="bx bx-arrow-back me-1"></i>Back to Login</a>
