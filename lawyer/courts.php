            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered example2">
                        ...
                        <?php
include('../includes/connection.php');
$sql="SELECT * FROM `court` INNER JOIN `province` ON `court`.province_cou=`province`.pro_id INNER JOIN `district` ON `court`.district_cou=`district`.dc_id  INNER JOIN `tehsil` ON `court`.tehsil_id=`tehsil`.th_id "; 
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu shadow animated--fade-in"
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item" href="update_court.php?upid=<?php echo $fet['cou_id']; ?>">
                                                    <i class="fas fa-pencil-alt"></i>
                                                    Edit
                                                </a>
                                            </li>
                                            <li>
                                                <a type="button" class="dropdown-item delete" data-id="<?php echo $fet['cou_id']; ?>">
...
?>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="court" id="inputCourt">
                        </div>
        ...
        success: function(res) {
            if (res == 1) {
                ...
                Swal.fire({
                    toast: true,
                    icon: 'success',
                    title: 'Court has not been added',
                    animation: false,
                    position: 'top-right',
                    showConfirmButton: false,
                    timer: 3000,
