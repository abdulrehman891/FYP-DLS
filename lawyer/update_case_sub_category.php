                ...
                <div class="card border-top border-0 border-4 border-dark">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            <h5 class="mb-0 text-dark">UPDATE CASE SUB CATEGORY</h5>
                        </div>
                        <hr>
                        <?php
                        $id=$_GET['upid'];
                        ...
                        <input type="hidden" class="form-control" name="case_sub_id" value="<?php echo $fet1['case_sub_id'];?>">
						<div class="col-md-12">
...
?>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="casesubcategory" value="<?php echo $fet1['sub_category'];?>" class="form-control" id="inputcasesubcategory">
                        </div>

                            <div class="col-12">
                             
                                <button type="submit" id="upda" class="btn btn-dark px-5">Update</button>
                                <a href="case_sub_category.php" class="btn btn-secondary px-5">Back</a>
                            </div>
                        </form>
...
$(document).ready(function() {
    $("#upda").on("click", function(g) {
        ...
        $.ajax({
            url: "./ajax/update_case_sub_category.php",
            method: "POST",
            contentType: false,
            processData: false,
            data: formdata,
            success: function(res) {
                ...
                if (res == 1) {
                    ...
                    Swal.fire({
                        toast: true,
                        icon: 'success',
                        title: 'Case sub category has been Updated',
                        animation: false,
                        position: 'top-right',
                        showConfirmButton: false,
                        timer: 3000,
                    ...
                    Swal.fire({
                        toast: true,
                        icon: 'warning',
                        title: 'Case sub category has not been Updated',
                        animation: false,
                        position: 'top-right',
                        showConfirmButton: false,
                        timer: 3000,
