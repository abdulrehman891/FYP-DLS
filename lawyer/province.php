                                        ...
                                        <ul class="dropdown-menu shadow animated--fade-in"
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item"
                                                    href="./update_province.php?upid=<?php echo $fet['pro_id']; ?>">
                                                    <i class="fas fa-pencil-alt"></i>
                                                    Edit
                                                </a>
                                            </li>
                                            <li>
                                                <a type="button" class="dropdown-item delete"
                                                    data-id="<?php echo $fet['pro_id']; ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" id="data">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="inputprovince" class="form-label">province <span
...
$("#subm").on("click", function(g) {
    ...
    $.ajax({
        url: "./ajax/add_province_ajax.php",
        method: "POST",
        contentType: false,
        processData: false,
        data: formdata,
        success: function(res) {
            if (res == 1) {
                ...
                Swal.fire({
                    toast: true,
                    icon: 'success',
                    title: 'province has not been added',
                    animation: false,
                    position: 'top-right',
                    showConfirmButton: false,
                    timer: 3000,
                ...
                success: function(result) {
                    ...
                    if (result == 1) {
                        ...
                        ({
                            toast: true,
                            icon: 'warning',
                            title: 'Province has not been deleted',
                            animation: false,
                            position: 'top-right',
                            showConfirmButton: false,
                            timer: 3000,
