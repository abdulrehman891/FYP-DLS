        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                ...
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    ...
                    <img src="assets/images/lawyers/<?php echo $row['lawyer_image'] ?>" class="user-img"
                        alt="user avatar">
                ...
                <?php
						...
						$lawyerEmail = $_SESSION['lawyer_email'];
					$sql = "SELECT * FROM lawyer_user_access WHERE user_access_email= '$lawyerEmail' ";
					$result = mysqli_query($conn, $sql);
					$row = mysqli_fetch_assoc($result);
					?>
                ...
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    ...
                    <div class="user-info ps-3">
                        <p class="user-name mb-0"><?php echo $row['user_access_name']; ?></p>
                        <p class="designattion mb-0"><?php echo $row['user'] ?></p>
                    </div>
                </a>
                <?php
