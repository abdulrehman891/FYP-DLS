                ...
                <div class="card border-top border-0 border-4 border-dark">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            <h5 class="mb-0 text-dark">UDATE COURT</h5>
                        </div>
                        <hr>
                        <?php
                        $id=$_GET['upid'];
                        $sql="SELECT * FROM `court` WHERE `cou_id`='$id'"; 
                        $run=mysqli_query($conn,$sql);
                        $fet1=mysqli_fetch_array($run); 
                        ?>

                        <form class="row g-3" id="data">
                        <input type="hidden" class="form-control" name="court_id" value="<?php echo $fet1['cou_id'];?>">
						<div class="col-md-12">
...
?>
                        ...
                        <div class="col-md-12">
                            <label for="inputCourt Name" class="form-label">Court <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="court" value="<?php echo $fet1['cou_name'];?>" id="inputCourt Name">
                        </div>

                            <div class="col-12">
                             
                                <button type="submit" id="upda" class="btn btn-dark px-5">Update</button>
                                <a href="courts.php" class="btn btn-secondary px-5">Back</a>
                            </div>
                        </form>
            ...
            success: function(res) {
                ...
                if (res == 1) {
                    ...
                    Swal.fire({
                        toast: true,
                        icon: 'warning',
                        title: 'Court has not been Updated',
                        animation: false,
                        position: 'top-right',
                        showConfirmButton: false,
                        timer: 3000,
