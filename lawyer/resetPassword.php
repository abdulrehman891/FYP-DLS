...
$sql = "SELECT * FROM lawyer WHERE token = '$token'";
...
if(isset($_REQUEST['change'])){
	...
	// Udpating Password
		...
		$sql = "UPDATE lawyer SET lawyer_pass = '$newPassword' WHERE token = '$token'";
		$result = mysqli_query($conn, $sql);
		if($result){
									...
									<div class="p-5">
										...
										<form action="" method="POST">
											...
											<div class="d-grid gap-2">
												<button type="submit" name="change" class="btn btn-dark">Change Password</button> <a href="lawyerLogin.php" class="btn btn-light"><i class="bx bx-arrow-back mr-1"></i>Back to Login</a>
											</div>
										</form>
