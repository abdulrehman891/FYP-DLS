      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <ul class="nav nav-tabs" id="rcases-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="icases-tab" data-bs-toggle="tab" data-bs-target="#icases" type="button" role="tab" aria-controls="icases" aria-selected="false">Important Cases</button>
            </li>
            <li class="nav-item" role="presentation">
