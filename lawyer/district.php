...
while ($fet=mysqli_fetch_array($run)) {
    ...
    <ul class="dropdown-menu shadow animated--fade-in"
        ...
        <li>
            <a type="button" class="dropdown-item" href="./update_district.php?upid=<?php echo $fet['dc_id']; ?>">
                <i class="fas fa-pencil-alt"></i>
                Edit
            </a>
        </li>
        <li>
            <a type="button" class="dropdown-item delete" data-id="<?php echo $fet['dc_id']; ?>">
            ...
            <div class="modal-body">
                ...
                <form action="" id="data">
                    ...
                    <div class="col-md-12">
                                ...
                                <select id="inputProvince" name="province" class="form-select">
                                    <?php
...
while ($fet=mysqli_fetch_array($run1)) {
	?>
                                    <option value="<?php echo $fet{'pro_id'};  ?>"> <?php echo $fet{'province'};  ?></option>
                                    <?php
}
?>
...
$("#subm").on("click", function(g) {
    ...
    $.ajax({
        url: "./ajax/add_district_ajax.php",
        method: "POST",
        contentType: false,
        processData: false,
        data: formdata,
        success: function(res) {
            if (res == 1) {
                ...
                Swal.fire({
                    toast: true,
                    icon: 'success',
                    title: 'district has not been added',
                    animation: false,
                    position: 'top-right',
                    showConfirmButton: false,
                    timer: 3000,
                ...
                success: function(result) {
                    ...
                    if (result == 1) {
                        ...
                        ({
                            toast: true,
                            icon: 'warning',
                            title: 'district has not been deleted',
                            animation: false,
                            position: 'top-right',
                            showConfirmButton: false,
                            timer: 3000,
