...
<div class="page-wrapper">
    <div class="page-content">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h6 class="mb-0 text-uppercase">Case Category</h6>
...
include('../includes/connection.php');
$sql="SELECT * FROM case_category INNER JOIN `case_type` ON `case_category`.casetype=`case_type`.case_id"; 
    ...
    <tr>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu shadow animated--fade-in"
                ...
                <li>
                    <a class="dropdown-item" href="./update_case_category.php?upid=<?php echo $fet['case_id']; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Case Category</h5>
...
?>
                        ...
                        <div class="col-md-12">
                            <label for="inputCaseType" class="form-label">Case Category <span
                                    class="text-danger">*</span></label>
                            <input type="text" name="casecategory" class="form-control" id="inputCaseType">
                        </div>
...
$(document).ready(function() {
    $("#subm").on("click", function(g) {
        ...
        $.ajax({
            url: "./ajax/add_case_category.php",
            method: "POST",
            contentType: false,
            processData: false,
            data: formdata,
            success: function(res) {
                ...
                if (res == 1) {
                    Swal.fire({
                        toast: true,
                        icon: 'success',
                        title: 'Case Category has been added',
                        animation: false,
                        position: 'top-right',
                    ...
                    Swal.fire({
                        toast: true,
                        icon: 'success',
                        title: 'Case Category has not been added',
                        animation: false,
                        position: 'top-right',
                        showConfirmButton: false,
                        timer: 3000,
...
$(document).on('click', '.delete', function() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: './ajax/delete_case_category.php',
                type: 'POST',
                data: {
                    id: tid
                },
                ...
                success: function(result) {
                    ...
                    if (result == 1) {
                        Swal.fire({
                            toast: true,
                            icon: 'success',
                            title: 'Case Category has been deleted',
                            animation: false,
                            position: 'top-right',
                            showConfirmButton: false,
                            timer: 3000,
                        ...
                        ({
                            toast: true,
                            icon: 'warning',
                            title: 'Case Category has not been deleted',
                            animation: false,
                            position: 'top-right',
                            showConfirmButton: false,
                            timer: 3000,
