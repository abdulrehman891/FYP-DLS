...
if(isset($_REQUEST['addClient'])){
	...
	if($clientName == "" || $clientCnic == "" || $clientGender == "" || $clientEmail == "" || $clientPassword == "" ||$clientMobile == "" || $clientAddress == "" || $clientCity == "" || $clientState == ""){
		...
		// Insert Data
		$sql = "INSERT INTO client(lawyer_id , client_name , client_cnic , client_gender, client_email,client_password, client_mobile, client_address, client_city, client_state, client_reference_name, client_reference_no, is_assign) VALUES ('$lawyerId', '$clientName','$clientCnic', '$clientGender', '$clientEmail', '$clientPassword','$clientMobile', '$clientAddress', '$clientCity', '$clientState', '$clientReferenceName', '$clientReferenceNo', 1)";
						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								...
								<form class="row g-3">
									...
									<div class="col-md-4">
										<label for="clientCnic" class="form-label">Cnic <span class="text-danger">*</span></label>
										<input type="text" class="form-control" name="clientCnic" id="clientCnic">
									</div>
									<div class="col-md-4">
									...
									<div class="col-md-6">
										<label for="clientCity" class="form-label">District<span class="text-danger">*</span></label>
									...
									<div class="col-12">
										<label for="clientDescription" class="form-label">Description <span class="text-danger">*</span></label>
										<textarea class="form-control" name="clientDescription"  id="inputDescription" placeholder="Description..." rows="3"></textarea>
									</div>
									...
									<div class="col-12">
										<button type="submit" name="addClient" class="btn btn-primary px-5">Add Client</button>
